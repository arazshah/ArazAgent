...
(رد کن),
  ...
  "commitment_to": اگر این آیتم یک تعهد یا قول مشخص به یک فرد دیگر است \
(نه به خود کاربر) — مثلاً قراری با کسی، کاری که به کسی قول داده شده، \
تحویل چیزی به کسی — نام یا مشخصهٔ آن فرد را بنویس (مثلاً "علی" یا \
"مشتری X"). این نوع تعهدها ریسک بیشتری دارند چون شکستن‌شان به اعتماد \
لطمه می‌زند. اگر آیتم فقط برای خود کاربر است (نه تعهد به فرد دیگری)، \
null بگذار,
